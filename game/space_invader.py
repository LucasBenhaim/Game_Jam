...
# Background Sound
mixer.music.load('data/space_invader/background.wav')
mixer.music.play(-1)

# player
playerImage = pygame.image.load('data/space_invader/spaceship.png')
player_X = 370
player_Y = 523
player_Xchange = 0
...
for num in range(no_of_invaders):
	invaderImage.append(pygame.image.load('data/space_invader/alien.png'))
...
bulletImage = pygame.image.load('data/space_invader/bullet.png')
bullet_X = 0
bullet_Y = 500
bullet_Xchange = 0
bullet_Ychange = 3
		...
		if event.type == pygame.KEYDOWN:
			...
			if event.key == pygame.K_SPACE:
				...
				if bullet_state is "rest":
					...
					bullet_sound = mixer.Sound('data/space_invader/bullet.wav')
					bullet_sound.play()
		...
		if invader_Y[i] >= 450:
			if abs(player_X-invader_X[i]) < 80:
				for j in range(no_of_invaders):
					invader_Y[j] = 2000
					explosion_sound = mixer.Sound('data/space_invader/explosion.wav')
